...
const fillCon = {
  ...
  edit_people_card: account.loginName,//编辑人工号
  edit_time: '',//编辑时间
  edit_content: '',//修改内容
  make_date: Date.now(),//拟稿日期
  create_people_name:account.name,//申请人姓名
  create_people_dept: account.dept_name,//申请部门
  ...
  first_purpose_code:'0',//*第一目的码
  other_purpose_code:'0',//其余目的码
...
const dataType = ["edit_time","contract_maketime","card_validity_time","write_card_validity","card_validity"]


export {fillCon,isShowType1,isShowType2,isShowType3,dataType}
