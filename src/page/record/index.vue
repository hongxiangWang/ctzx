...
<script>
    ...
    import {dataType} from './fillTable.js'
    let fillTableData = {};
    let uploadData = {};
    let ajaxData = {};
    export default {
...
//                        return;
            ...
            submit(){
                ...
                this.$refs.recordCon.$refs['uploadForm'].validate((valid) => {
                    console.log('ajaxData----', valid)
                    if (valid) {
                        ajaxData = Object.assign(fillTableData, uploadData);
                        dealBeloo(ajaxData);
                        dealDataType(ajaxData);
                        ...
                        this.$ajax.post('/business/addbusiness', params).then(response => {
                            ...
                            if (Number(response.data.data.flg) == 0) {
                                ...
                                this.$refs.ruleForm = require('./fillTable.js').fillCon;
                            } else {
    ...
    function dealBeloo(json) {
        ...
        json.is_telephone_number = json.is_telephone_number ? '是' : '否';
